...
class main extends AWS_CONTROLLER
{
	...
	public function question_action()
	{
		...
		TPL::assign('sidebar_hot_users', $this->model('module')->sidebar_hot_users($this->user_id, 8));//同道中人
	...
	public function index_action()
	{
		...
		{
			$posts_list = $this->model('posts')->get_posts_list(null, $_GET['page'], get_setting('contents_per_page'), $_GET['sort_type'], null, $category_info['id'], $_GET['answer_count'], day-0, is_recommend-1);
		}
		...
		TPL::assign('sidebar_hot_users', $this->model('module')->sidebar_hot_users($this->user_id, 6));//同道中人
		TPL::output('m/index');
	}
	...
	
	{
		...
		$this->crumb($article_info['title'], '/m/article/' . $article_info['id']);
